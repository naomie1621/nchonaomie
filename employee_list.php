  ...
  <div class="row">
    ...
    <?php foreach ($employeelist as $e){ ?>
      <tr>
        ...
        <td><?php if (isset($e->EmployeeID)) echo '<a href="index.php?c=employee&m=add&id='.$e->EmployeeID.'" data-toggle="tooltip" title="Ajouter" class="btn btn-primary  btn-sm"><i class="fas fa-plus"></i></a>';?></td>
      </tr>
    <?php }?> 
    </tbody>
    </table>
